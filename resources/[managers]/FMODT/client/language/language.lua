...
--Admin Menu
	...
	KickYourselfMessage = "Tu es kick de notre serveur PaladiumRP"

	BanPlayerTitle = "Tu es bannis de notre serveur PaladiumRP"
	BanYourselfMessage = "Tu es bannis de notre serveur PaladiumRP"
	BanDurationMessage1 = "Tu es bannis de notre serveur PaladiumRP Pour 1-Heure"
