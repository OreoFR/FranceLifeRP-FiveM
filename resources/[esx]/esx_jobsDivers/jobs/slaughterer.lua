Config.Jobs.slaughterer = {
	...
	Zones = {
		CloakRoom = { 
			Pos   = {x = -1071.1319580078, y = -2003.7891845703, z = 14.78551197052}, -- ok
			Size  = {x = 3.0, y = 3.0, z = 1.0}, -- ok
			Color = {r = 204, g = 204, b = 0}, -- ok
			Marker= 1, -- bon
			Blip  = true, -- bon 
			Name  = _U('s_slaughter_locker'), -- fonctionne pas
			Type  = "cloakroom",
			...
			Item  = {
				{
					...
					time   = 3000,
					max    = 20, -- prise de poulets vivants
					add    = 1,
					remove = 1,
					requires = "nothing",
			...
			Item  = {
				{
					...
					time   = 5000,
					max    = 20, -- quantiter de poulets tuer
					add    = 1,
					remove = 1,
			...
			Item  = {
				{
					...
					time   = 4000,
					max    = 100, -- quantités en barquettes 
					add    = 5,
					remove = 1,
		...
		Delivery = {
			...
			Item  = {
				{
					name   = _U('delivery'),
					time   = 500, -- temps de revente "tres rapide"
					remove = 1,
					max    = 100, --  vente barquettes   (if not present, probably an error at itemQtty >= item.max in esx_jobs_sv.lua)
					price  = 11,  -- prix de la barquette
