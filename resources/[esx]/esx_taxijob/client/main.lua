  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if data.current.value == 'cloakroom' then
            ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin)
              ...
              if skin.sex == 0 then
                ...
                SetPedComponentVariation(playerPed, 11, 31, 0, 0) --Torse
                SetPedComponentVariation(playerPed, 10, 0, 0, 0) --Decals
                SetPedComponentVariation(playerPed, 3, 22, 0, 0) --Bras
                SetPedComponentVariation(playerPed, 4, 24, 0, 0) --Pantalon
                SetPedComponentVariation(playerPed, 6, 10, 0, 0) --Chaussures
                SetPedComponentVariation(playerPed, 7, 38, 0, 0) --Collier
                SetPedPropIndex(playerPed, 1, 18, 3, 0) -- Lunettes
                ...
                SetPedComponentVariation(playerPed, 8, 38, 0, 0) --T-shirt
                SetPedComponentVariation(playerPed, 11, 7, 0, 0) --Torse
                SetPedComponentVariation(playerPed, 10, 0, 0, 0) --Decals
                SetPedComponentVariation(playerPed, 3, 25, 0, 0) --Bras
                SetPedComponentVariation(playerPed, 4, 34, 0, 0) --Pantalon
                SetPedComponentVariation(playerPed, 6, 0, 0, 0) --Chaussures
                SetPedComponentVariation(playerPed, 7, 0, 0, 0) --Collier
                SetPedPropIndex(playerPed, 1, 11, 1, 0) -- Lunettes
      ...
      if data.current.value == 'boss_actions' then
        TriggerEvent('esx_society:BossMenuOpen1', 'taxi', function(data, menu)
          menu.close()
        end)
      end
