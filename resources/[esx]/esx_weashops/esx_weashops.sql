...
INSERT INTO `weashops` (name, item, price) VALUES
	('BlackWeashop', 'WEAPON_KNUCKLE', 3000),
	('BlackWeashop', 'WEAPON_SWITCHBLADE', 6000),	
	('BlackWeashop', 'WEAPON_VINTAGEPISTOL', 38000),
	('BlackWeashop', 'WEAPON_PISTOL50', 50000),
	('BlackWeashop', 'WEAPON_SAWNOFFSHOTGUN', 64000),
	('BlackWeashop', 'WEAPON_MINISMG', 70000)
;
