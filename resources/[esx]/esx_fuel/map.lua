        ...
        for _, item in pairs(station) do
            ...
            if(near) then
                ...
                if(dist<10) then
               		...
               		DrawText3D(x,y,z-0.2, "~b~"..settings[lang].price.." : "..StationsPrice[item.s].."$/L - Niveau Station: ".. StationsEssence[item.s].montant .."/L")
               	end
            end
        end
...
AddEventHandler("essence:sendEssence",function(st)
    StationsEssence = st
end)