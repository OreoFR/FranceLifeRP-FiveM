Locales['fr'] = {
  ...
  -- Brasseur
  ['bra_cloakroom']                 = 'Vestiaire',
  ['bra_production']                = 'Production',
  ['bra_recolte']                   = 'Recolte',
  ['bra_vendor']                    = 'Vendeur',
  ['bra_recoltebutton']             = 'appuyez sur ~INPUT_PICKUP~ pour récolter du Houblon',
  ['bra_beer_fab_button']           = 'appuyez sur ~INPUT_PICKUP~ pour traité le Houblon',
