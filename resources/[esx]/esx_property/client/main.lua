            ...
            function(data2, menu)
              ...
              menu.close()
                if quantity > 0 then
                    ...
                    TriggerServerEvent('esx_property:print', owner)
                    DrawSub("~r~~h~ Essaie de redupliquer tu sera ban ;)", 5000)

                end
--drawTxt("~r~ Essaies-tu de dupliquer ? Nous l'avons corrigé ;)",0,1,0.5,0.8,0.6,255,255,255,255)
              ESX.SetTimeout(300, function()
                OpenPlayerInventoryMenu(property, owner)
              end)
