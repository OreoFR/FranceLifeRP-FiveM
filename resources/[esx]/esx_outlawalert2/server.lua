...
RegisterServerEvent('thiefInProgressfib')
AddEventHandler('thiefInProgressfib', function(street1, street2, veh, sex)
	if veh == "NULL" then
...
RegisterServerEvent('thiefInProgressS1fib')
AddEventHandler('thiefInProgressS1fib', function(street1, veh, sex)
	if veh == "NULL" then
