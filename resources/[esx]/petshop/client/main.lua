...
function buy_animal()
    ...
    local price = price
    local elements = {}
    table.insert(elements, {label = _U('dog') .. '- <span style="color:green;">$10000</span>',             					value = "chien",	price = 10000})		
    table.insert(elements, {label = _U('cat') .. '- <span style="color:green;">$1000</span>',             					value = "chat", price = 1000})
    table.insert(elements, {label = _U('wolf') .. '- <span style="color:green;">$40000</span>',             					value = "loup", price = 40000})
    table.insert(elements, {label = _U('bunny') .. '- <span style="color:green;">$600</span>',             					value = "lapin",	price = 600})
    table.insert(elements, {label = _U('husky') .. '- <span style="color:green;">$100000</span>',             					value = "husky", price = 100000})
    table.insert(elements, {label = _U('pig') .. '- <span style="color:green;">$25000</span>',             					value = "cochon", price = 25000})
    table.insert(elements, {label = _U('poodle') .. '- <span style="color:green;">$5000</span>',             					value = "caniche", price = 5000})
