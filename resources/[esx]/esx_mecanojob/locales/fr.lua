Locales['fr'] = {
  ...
  ['blowtorch']                 = 'Fabrication de Chalumeaux',
  ['repair_kit']                = 'Fabrication de Kit de Réparation',
  ...
  ['assembling_blowtorch']      = 'Assemblage d\'un ~b~Chalumeau~s~',
  ['not_enough_body_tools']     = 'Vous n\'avez ~r~pas assez~s~ d\'outils de réparation',
  ...
  ['assembling_fixkit']         = 'Assemblage d\'un ~b~Kit de Réparation~s~'
}
