...
Config.Zones = {
  -- Sorti vehicule/Boss
  MecanoActions = {
    Pos   = { x = -1151.486, y = -1691.836, z = 3.449 },
  ...
  --Recolte Craft
  Garage = {
    Pos   = { x = 2750.908, y = 3471.922, z = 55.698 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Color = { r = 255, g = 0, b = 0 },
    Type  = 1,
  },
  ...
  Craft = {
    Pos   = { x = -1188.176, y = -1704.093, z = 3.449 },
   Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Color = { r = 255, g = 255, b = 255 },
    Type  = 1,
  },
  ...
  VehicleSpawnPoint = {
    Pos   = { x = -1194.265, y = -1716.296, z = 3.448 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Type  = -1,
  },

  VehicleDeleter = {
    Pos   = { x = -1179.445, y = -1731.146, z = 3.448 },
    Size  = { x = 3.0, y = 3.0, z = 1.0 },
    Color = { r = 60, g = 1730, b = 245 },
    Type  = 1,
  },
