...
function OpenSocietyActionsMenu()
  ...
  local elements = {}
  	...
  	if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.grade_name == 'boss' or 'barman' then
          ...
          ESX.UI.Menu.Open(
              'default', GetCurrentResourceName(), 'menu_crafting',
              {
                  ...
                  elements = {
                        ...
                        {label = _U('sexonthebeach'),  value = 'sexonthebeach'},
                        {label = _U('monaco'),         value = 'monaco'},
                        {label = _U('oiseaujaune'),    value = 'oiseaujaune'},
                        {label = _U('tequilasunrise'), value = 'tequilasunrise'},
                        {label = _U('rosedelanuit'),   value = 'rosedelanuit'},
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
          ...
          TriggerEvent('esx_society:BossMenuOpen1', 'unicorn', function(data, menu)
