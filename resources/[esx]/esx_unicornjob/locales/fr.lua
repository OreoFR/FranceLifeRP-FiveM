Locales['fr'] = {
    ...
    ['grenadine']                 = 'Grenadine',
    ['used_sexonthebeach']        = 'Vous avez bu un ~p~Sex On The Beach !~p~',
    ['monaco']                    = 'Monaco',
    ['biere']                     = 'Bière',
    ['used_monaco']               = 'Vous avez bu un ~p~Monaco !~p~',
    ['oiseaujaune']               = 'Oiseau Jaune',
    ['used_oiseaujaune']          = 'Vous avez bu un ~p~Oiseau Jaune !~p~',
    ['lu_chiew']                  = 'Mei Kuei Lu Chiew',
    ['juscitron']                 = 'Jus De Citron',
    ['rosedelanuit']              = 'Rose De La Nuit',
    ['used_rosedelanuit']         = 'Vous avez bu une ~p~Rose De La Nuit !~p~',
    ['tequilasunrise']            = 'Tequila Sunrise',
    ['used_tequilasunrise']       = 'Vous avez bu une ~p~Tequila Sunrise !~p~',
    ['tequila']                   = 'Tequila',
