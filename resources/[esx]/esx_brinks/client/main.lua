  ...
  while true do
    ...
    if NPCTargetDAB ~= nil then
      ...
      if GetDistanceBetweenCoords(coords, zone.Pos.x, zone.Pos.y, zone.Pos.z, true) < 3 then
        ...
        if IsControlJustReleased(1, Keys["N5"]) and PlayerData.second_job ~= nil then
          StopNPCJob()
          Wait(300)
          Done = false
        end
...
function CreateBlip()
  if PlayerData.second_job ~= nil and PlayerData.second_job.name == Config.nameJob then
  ...
  if PlayerData.second_job ~= nil and PlayerData.second_job.name == Config.nameJob and onDuty then
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.second_job ~= nil then
      ...
      if PlayerData.second_job.name == Config.nameJob then
        if onDuty then
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if (IsControlJustReleased(1, Keys["E"]) or IsControlJustReleased(2, Keys["RIGHT"])) and PlayerData.second_job ~= nil then
        local playerPed = GetPlayerPed(-1)
        if PlayerData.second_job.name == Config.nameJob then
...
Citizen.CreateThread(function()
  while true do
    ...
    if IsControlJustReleased(1, Keys["DELETE"]) and PlayerData.second_job ~= nil and PlayerData.second_job.name == Config.nameJob then
