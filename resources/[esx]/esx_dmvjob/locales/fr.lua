Locales['fr'] = {
    ...
    ['unicorn_fridge_stock']     = 'Stock du Auto-école',
    ['fridge_inventory']         = 'Contenu du frigo',

    -- Shops  
    ['shop']                     = 'Boutique de Auto-école',
    ...
    ['unicorn_stock']            = 'Stock du Auto-école',
    ...
    ['assembling']      = 'Création en cours... !',
    ['craft_miss']               = 'Malheureux échec de la création...',
    ['not_enough']               = 'Pas assez de ~r~ ',
    ['craft']                    = 'Création terminé de ~g~',
