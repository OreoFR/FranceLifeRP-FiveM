...
function OpenVehicleMenu() -- Menu location véhicules
    ...
    local elements = {
        {label = 'Velo', value = 'cruiser', price = 200}, -- Véhicule n°1
        {label = 'Scooter', value = 'faggio2', price = 1000} -- Véhicule n°2
    }
        ...
        function(data, menu)
            for i=1, #elements, 1 do
                ...
                ESX.Game.SpawnVehicle(data.current.value, coords, 200.0, function(vehicle)
                    ...
                    SetVehicleNumberPlateText(vehicle, 'LOCFEDERAL' .. platenum) -- Modification de la plaque d'immatriculation en LOCATION
                end)
